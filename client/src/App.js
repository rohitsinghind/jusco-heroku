        ...
        <Router>
          <Routes>
            ...
            <Route
              ...
              element={<CustomerDashboard userData={userData} />}
            />
            <Route path="/adminLogin" element={<AdminLogin />} />
            <Route
              path="/depoManagerDashboard"
              element={
                <DepoManagerDashboard setApplicantData={setApplicantData} />
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <AccountManagerDashboard setApplicantData={setApplicantData} />
              }
            />
            <Route
            ...
            <Route
              path="/hodDashboard"
              element={<HodDashboard setApplicantData={setApplicantData} />}
            />
            <Route
            ...
            <Route
              ...
              element={
                <DoorToDoorVerification setApplicantData={setApplicantData} />
              }
            />
            <Route
